...
@section('title', 'Gratins')

@section('content')
<div class="container">
    <div class="row">
        <h1 class="text-center text-muted mb-3 mt-5">Nos gratins</h1>
        <div class="row">
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col col-md-7">
                    @forelse ($gratins as $recipe)
                        <div class="card mb-3">
                            <div class="row g-0">
                                <div class="col-md-4">
                    ...
                    @empty
                        <div>Aucun gratin ajouté.</div>
                    @endforelse
                    <div class="row">
                        {{ $gratins->onEachSide(2)->links() }}
                    </div>
                </div>
            </div>
        </div>

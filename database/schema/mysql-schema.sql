...
CREATE TABLE `ingredient_recipe` (
  ...
  `quantity_ingredient` decimal(8,2) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ingredient_recipe_recipe_id_ingredient_id_unique` (`recipe_id`,`ingredient_id`),
...
CREATE TABLE `ingredients` (
  ...
  `nutri_value` decimal(8,2) NOT NULL,
  `unit` enum('gramme','litre','portion') NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `recipes` (
  ...
  `type_recipe` enum('entrée','plat principal','dessert') NOT NULL,
  `number_per` int(11) NOT NULL,
...
INSERT INTO `migrations` VALUES (5,'2023_02_10_141725_create_recipes_table',1);
INSERT INTO `migrations` VALUES (6,'2023_02_12_114240_create_ingredients_table',1);
